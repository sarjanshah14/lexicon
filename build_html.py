...
table.wide th, table.wide td{overflow-wrap:break-word; word-break:break-word; padding:7px 8px;}
/* numbered tables (Top 100 / Top 101-250): keep "#" and "POS" columns slim */
...
/* in-page ToC list (right after first h2) gets a card look via class added by JS.
   Extra left padding so two-digit numbers (10, 11) stay inside the box. */
.toc-card{background:#f6f6f3; border:1px solid var(--line); border-radius:10px;
  padding:14px 24px 14px 44px; margin:1.2em 0;}
.toc-card li{margin:.3em 0; padding-left:4px;}
